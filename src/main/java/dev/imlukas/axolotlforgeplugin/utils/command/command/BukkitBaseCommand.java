package dev.imlukas.axolotlforgeplugin.utils.command.command;

import dev.imlukas.axolotlforgeplugin.utils.collection.Pair;
import dev.imlukas.axolotlforgeplugin.utils.command.language.AbstractObjectiveModel;
