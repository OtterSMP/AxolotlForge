package dev.imlukas.axolotlforgeplugin.utils.item.parser;

import dev.imlukas.axolotlforgeplugin.utils.item.trim.TrimMaterialType;
import dev.imlukas.axolotlforgeplugin.utils.item.trim.TrimPatternType;
